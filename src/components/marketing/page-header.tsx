...
export function PageHeader({
  ...
  return (
    <section className="relative overflow-hidden border-b border-white/10">
      <div className="pointer-events-none absolute inset-0 -z-10 bg-grid-dark opacity-50" aria-hidden="true" />
      ...
      <div className="mx-auto max-w-4xl px-4 pb-16 pt-32 text-center sm:px-6 sm:pt-36 lg:px-8">
        <div className="animate-rise">
          {eyebrow && (
            <span className="font-[family-name:var(--font-geist-mono)] text-[12px] tracking-tight text-teal-400">
              {eyebrow}
            </span>
          )}
          <h1 className="mt-4 text-balance text-4xl font-semibold tracking-[-0.025em] text-zinc-50 sm:text-5xl">
            {title}
          </h1>
          {subtitle && (
            <p className="mx-auto mt-5 max-w-2xl text-balance text-lg leading-relaxed text-zinc-400">
              {subtitle}
            </p>
          )}
        </div>
