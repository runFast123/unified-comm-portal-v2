  ...
  return (
    <div className="relative [perspective:1800px]" aria-hidden="true">
      <div className="relative [transform-style:preserve-3d] [transform:rotateY(-11deg)_rotateX(3deg)] sm:[transform:rotateY(-13deg)_rotateX(4deg)]">
        ...
        <div className="animate-rise rounded-xl border border-zinc-200 bg-white p-3">
            ...
            {ROWS.map((r) => (
              <div
                ...
                className={`flex items-center gap-2.5 rounded-md px-2.5 py-2 ${
                  r.active ? 'border-l-2 border-teal-600 bg-zinc-100' : 'border-l-2 border-transparent'
                }`}
              >
        ...
        <div className="animate-rise absolute -bottom-12 -left-6 w-[78%] rounded-xl border border-zinc-300 bg-white p-3.5 shadow-xl shadow-zinc-300/30 [animation-delay:160ms] [transform:translateZ(70px)] sm:-left-10">
          <div className="flex items-center justify-between">
            <span className="text-[12px] font-medium text-zinc-800">Ava Chen</span>
          ...
          <div className="mt-3 rounded-lg border border-teal-200 bg-teal-50 p-2.5">
            ...
            <div className="mt-2 flex gap-1.5">
              ...
              <span className="rounded-md border border-zinc-300 px-2 py-1 text-[10px] font-medium text-zinc-600">Edit</span>
            </div>
          </div>
        </div>
      </div>
