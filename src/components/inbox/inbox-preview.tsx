...
export function InboxPreview({ item }: InboxPreviewProps) {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* AI Draft Section */}
      {data.aiDraft && (
        <div className="shrink-0 border-b border-gray-200 bg-purple-50 px-5 py-4">
      ...
      <div className="shrink-0 border-t border-gray-200 bg-white px-5 py-4 space-y-3">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={2}
            className="flex-1 text-sm rounded-lg border border-gray-200 px-3 py-2.5 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none resize-none"
          />
          <Button
            variant="primary"
            size="sm"
